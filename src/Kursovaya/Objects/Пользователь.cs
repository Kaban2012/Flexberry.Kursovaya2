...
namespace IIS.Kursovaya
{
    ...
    public class Пользователь : ICSSoft.STORMNET.DataObject
    {
        ...
        /// РабочаяПочта.
        /// </summary>
        // *** Start programmer edit section *** (Пользователь.РабочаяПочта CustomAttributes)

        // *** End programmer edit section *** (Пользователь.РабочаяПочта CustomAttributes)
        [StrLen(255)]
        public virtual string РабочаяПочта
        {
            get
            {
                // *** Start programmer edit section *** (Пользователь.РабочаяПочта Get start)

                // *** End programmer edit section *** (Пользователь.РабочаяПочта Get start)
                string result = this.fРабочаяПочта;
                // *** Start programmer edit section *** (Пользователь.РабочаяПочта Get end)

                // *** End programmer edit section *** (Пользователь.РабочаяПочта Get end)
                return result;
            }
            set
            {
                // *** Start programmer edit section *** (Пользователь.РабочаяПочта Set start)

                // *** End programmer edit section *** (Пользователь.РабочаяПочта Set start)
                this.fРабочаяПочта = value;
                // *** Start programmer edit section *** (Пользователь.РабочаяПочта Set end)

                // *** End programmer edit section *** (Пользователь.РабочаяПочта Set end)
            }
        }
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПользовательE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПользовательE", typeof(IIS.Kursovaya.Пользователь));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПользовательL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПользовательL", typeof(IIS.Kursovaya.Пользователь));
                }
            }
        }
    }
