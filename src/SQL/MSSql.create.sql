...
CREATE TABLE [ВозвратКлиентом] (
	 ...
	 [Модель] UNIQUEIDENTIFIER  NOT NULL,

	 [Тип] UNIQUEIDENTIFIER  NOT NULL,

	 [Филиал] UNIQUEIDENTIFIER  NOT NULL,
...
CREATE TABLE [РезервОборуд] (
	 ...
	 [ПереданоКлиенту] BIT  NULL,

	 [СерийныйНомер] VARCHAR(255)  NULL,

	 [Администратор] UNIQUEIDENTIFIER  NOT NULL,
...
CREATE TABLE [Филиал] (
	 ...
	 [Директор] UNIQUEIDENTIFIER  NOT NULL,
